...
extension String {
    ...
    public  var urlEscaped: String {
     ...
     public func escapeTerminalString() -> String {
         return self.replacingOccurrences(of: "\"", with: "\\\"", options:[], range: nil)
     }
     
     public func isEmptyRemoveSpaces() -> Bool {
         return trimmingCharacters(in: CharacterSet.whitespaces).isEmpty
     }

     public func isUrlContainParameter(key: String) -> Bool {
         guard let url = URL(string: self) else { return false }
         return url.isContainsParameter(key: key)
     }
     ...
     public func toJson() -> Dictionary<AnyHashable, Any>? {
 ...
 extension NSMutableData {
     ...
     public func appendBytes(_ arrayOfBytes: [UInt8]) {
         append(arrayOfBytes, length: arrayOfBytes.count)
     }

 }

public func toUInt32Array(_ slice: ArraySlice<UInt8>) -> [UInt32] {
     var result = [UInt32]()
